            ...
            <div>
                ...
                <div className="flex flex-wrap place-items-center  ">
                    <section className="relative mx-auto">
                        {/* navbar */}
                        <nav className="flex justify-between bg-gray-600 text-white w-screen">
                            <div className="px-5 xl:px-12 py-6 flex w-full items-center">
                                <a className="text-3xl font-bold font-heading" href="#">
                                    {/* <img class="h-10" src="https://i.ibb.co/vjYjDWD/Orange-Black-Hummingbird-Tech-Digital-Bird-Logo.png" alt="logo" /> */}
                                    NEXT_JS
                                </a>
                                {/* Nav Links */}
